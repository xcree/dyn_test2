...
#define SWITCH_MODE_PUMP       0x0     //Switch Mode Pump value
#define SWITCH_MODE_PUMP_MASK  0x80    //Switch Mode Pump mask
#define SWITCH_MODE_PUMP_JUST  0x0     //Switch Mode Pump value justified
#define TRIP_VOLTAGE           0x0     //Trip Voltage
#define POWER_SETTING          0x5     //Power Setting 
...
#define CLOCK_DIV_VC2          0xc     // VC2 clock divider 
#define CLOCK_DIV_VC2_MASK     0xf     // VC2 clock divider mask
#define CLOCK_DIV_VC2_JUST     0xc     // VC2 clock divider justified
...
#define PORT_0_GLOBAL_SELECT   0x4a    //Port 0 global select register (PRT0GS)
#define PORT_0_DRIVE_0         0xca    //Port 0 drive mode 0 register (PRT0DM0)
#define PORT_0_DRIVE_1         0x15    //Port 0 drive mode 1 register (PRT0DM1)
#define PORT_0_DRIVE_2         0x15    //Port 0 drive mode 1 register (PRT0DM2)
...
#define PORT_1_GLOBAL_SELECT   0x1     //Port 1 global select register (PRT1GS)
#define PORT_1_DRIVE_0         0x1     //Port 1 drive mode 0 register (PRT1DM0)
#define PORT_1_DRIVE_1         0xd6    //Port 1 drive mode 1 register (PRT1DM1)
#define PORT_1_DRIVE_2         0xd6    //Port 1 drive mode 2 register (PRT1DM2)
#define PORT_1_INTENABLE       0x28    //Port 1 interrupt enable register (PRT1IE)
#define PORT_1_INTCTRL_0       0x28    //Port 1 interrupt control 0 register (PRT1IC0)
#define PORT_1_INTCTRL_1       0x28    //Port 1 interrupt control 1 register (PRT1IC1)
