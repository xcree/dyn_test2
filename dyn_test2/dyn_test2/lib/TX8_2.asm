...
;  Global Symbols
;-----------------------------------------------
export   TX8_2_SetTxIntMode
export  _TX8_2_SetTxIntMode
export   TX8_2_EnableInt
export  _TX8_2_EnableInt
export   TX8_2_DisableInt
export  _TX8_2_DisableInt
export   TX8_2_Start
export  _TX8_2_Start
export   TX8_2_Stop
export  _TX8_2_Stop
export   TX8_2_SendData
export  _TX8_2_SendData
export   TX8_2_bReadTxStatus
export  _TX8_2_bReadTxStatus

// Old labels, will be removed in future release
// Do Not Use.
export   bTX8_2_ReadTxStatus
export  _bTX8_2_ReadTxStatus

;-----------------------------------------------
;  High Level TX functions
;-----------------------------------------------
export  TX8_2_PutSHexByte
export _TX8_2_PutSHexByte
export  TX8_2_PutSHexInt
export _TX8_2_PutSHexInt

export  TX8_2_CPutString
export _TX8_2_CPutString
export  TX8_2_PutString
export _TX8_2_PutString
export  TX8_2_PutChar
export _TX8_2_PutChar
export  TX8_2_Write
export _TX8_2_Write
export  TX8_2_CWrite
export _TX8_2_CWrite
export  TX8_2_PutCRLF
export _TX8_2_PutCRLF 
...
_TX8_2_EnableInt:
   ...
   M8C_EnableIntMask  TX8_2_INT_REG, TX8_2_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_2_DisableInt
;
;  DESCRIPTION:
...
_TX8_2_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask TX8_2_INT_REG, TX8_2_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_2_SetTxIntMode(BYTE bTxIntMode)
;
;  DESCRIPTION:
...
_TX8_2_SetTxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   A, TX8_2_INT_MODE_TX_COMPLETE
   jz    .SetModeRegEmpty
   or    REG[TX8_2_FUNC_REG], bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.SetModeRegEmpty:
   and   REG[TX8_2_FUNC_REG], ~bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_2_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_TX8_2_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[TX8_2_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_2_bReadTxStatus
;
;  DESCRIPTION:
...
;
 TX8_2_bReadTxStatus:
_TX8_2_bReadTxStatus:
 bTX8_2_ReadTxStatus:
_bTX8_2_ReadTxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[TX8_2_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_2_PutSHexByte
;
;  DESCRIPTION:
...
_TX8_2_PutSHexByte:
    ...
    index TX8_2_HEX_STR                ; Get Hex value
    call  TX8_2_PutChar                ; Write data to screen
    pop   A                            ; Restore value
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_2_PutSHexInt
;
;  DESCRIPTION:
...
_TX8_2_PutSHexInt:
    RAM_PROLOGUE RAM_USE_CLASS_1
    swap  A,X
    call  TX8_2_PutSHexByte            ; Print MSB
    mov   A,X                          ; Move LSB into position
    call  TX8_2_PutSHexByte            ; Print LSB
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
...
.BufEmptyWaitLoop:
   tst REG[TX8_2_CONTROL_REG], TX8_2_TX_BUFFER_EMPTY    ; Check Tx Status
   jz  .BufEmptyWaitLoop
   mov REG[TX8_2_TX_BUFFER_REG], @Source    ; Write data to Tx Port
   endm
...
.PutStringLoop:
   ...
   call  TX8_2_PutChar                      ; Send character to Tx port
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_2_CPutString
;
;  DESCRIPTION:
;     Send String out through UART TX port.
;
...
_TX8_2_CPutString:
   ...
   romx                                          ; Get character from ROM
   jz    .End_CPutString
   call  TX8_2_PutChar                      ; Print character
   pop   X
   pop   A
   inc   X                                       ; Inc LSB of pointer
   jnc   TX8_2_CPutString                        ; Check for carry
   inc   A                                       ; Inc MSB of pointer
   jmp   TX8_2_CPutString
